...
export const portfolioData: PortfolioData = {
  ...
  bioLong:
    "Sou UX/UI Designer com mais de 3 anos de experiência na criação de produtos digitais. Meu foco profissional envolve design systems, prototipagem, usabilidade e Figma, sempre com atenção à construção de experiências intuitivas. Estou finalizando minha formação em Engenharia de Software e também cursando o IAUX Designer, do Leandro Rezende, da UX Unicórnio, ampliando minha visão sobre a integração entre experiência do usuário, inteligência artificial e desenvolvimento de produtos digitais. Atuei por um bom tempo em uma empresa de tecnologia voltada ao mercado segurador, contexto em que clareza, consistência e compreensão de fluxos complexos são fundamentais. Integro ferramentas como Figma Make, Bolt.new e agentes de IA ao meu fluxo de prototipagem e análise de jornadas, acelerando a validação de hipóteses com precisão.",
